...
def get_argparser():
	parser = argparse.ArgumentParser("List apps by using Ledger to open a Secure Channel.")
	parser.add_argument("--url", help="Websocket URL", default="wss://scriptrunner.api.live.ledger.com/update/apps/list")
